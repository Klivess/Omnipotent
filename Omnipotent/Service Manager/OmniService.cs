...
namespace Omnipotent.Service_Manager
{
    ...
    public class OmniService
    {
        ...
        public void ServiceStart()
        {
            if (ServiceActive)
            {
                //This is 100% going to cause problems for me in like 7 months.
                RestartService();
            }
            else
            {
        ...
        protected void CatchError(Exception ex)
        {
            ...
            LogStatus($"ERROR! Task {name} has crashed due to: "+ex.Message.ToString());   
        }
