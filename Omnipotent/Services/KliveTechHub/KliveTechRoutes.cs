...
#pragma warning disable CS4014 // Because this call is not awaited, execution of the current method continues before the call is completed
        ...
        {
            await p.CreateAPIRoute("/klivetech/GetAllGadgets", async (req) =>
            {
                try
                {
            ...
            await p.CreateAPIRoute("/klivetech/executegadgetaction", async (req) =>
            {
            ...
            await p.CreateAPIRoute("/klivetech/GetGadgetByID", async (req) =>
            {
                try
                {
